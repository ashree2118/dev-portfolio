const contributions = [
  {
    message: "Add dedicated preset for shelter_type=field_shelter (Resolves #851)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/2065",
  },
  {
    message: "Add preset for barrier-sliding_gate (Resolves #1771)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/2030",
  },
  {
    message: "Add preset for natural=arete",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/2024",
  },
  {
    message: "Add support field to memorial plaque preset (Resolves #1381)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/2015",
  },
  {
    message: "Added a preset for leisure=summer_camp to (Resolves #1481)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/2000",
  },
  {
    message: "Add preset for amenity-kitchen (#1631)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/1993",
  },
  {
    message: "Show access field on amenity-shelter if tagged (#887)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/1967",
  },
  {
    message: "Stop deprecating landuse=basin (#1804)",
    repo: "openstreetmap/id-tagging-schema",
    year: "2026",
    url: "https://github.com/openstreetmap/id-tagging-schema/pull/1955",
  },
];
